...
def add_gamer(gamer, gamers_list):
    if 'name' in gamer and 'availability' in gamer: gamers_list.append(gamer)
...
def available_on_night(gamers_list, day):
    people_available = []
    for dictionary in gamers_list:
        for days in dictionary['availability']:
            if days == day: people_available.append(dictionary['name'])
...
form_email = "Dear {name}, \n This is your host of game night at Sorcery Society. I am happy to inform you that game night will be on {day_of_week} this week. We will be enjoying a rousing game of \"{game}\". I hope you can join us!\n\nSincerely,\nHead Wizard"
